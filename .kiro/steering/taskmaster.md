...
covering both the recommended MCP tools, suitable for integrations like Kiro,
...
- **Usage:** Run this once at the beginning of a new project, typically via an
  integrated tool like Kiro. Operates on the current working directory of the
  MCP server.
...
within the `env` section of your **`.kiro/mcp.json`** file (for MCP/Kiro
...
[dev_workflow.md](.kiro/steering/dev_workflow.md).
